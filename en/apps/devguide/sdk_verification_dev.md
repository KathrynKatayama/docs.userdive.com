...
- [Operation Check with Developer Mode SDK](#operation-check-with-developer-mode-sdk)
  - [Check the start of the operation](#check-the-start-of-the-operation)
  - [Check the capturing operation](#check-the-capturing-operation)
  - [Check the uploaded screen capture](#check-the-uploaded-screen-capture)
